 ...
 * "Windowsmachines". Anything adjacent to an existing space scores zero,
 ...
 *
 * A lowercase-to-lowercase join like "Windowsmachines" is genuinely ambiguous:
 * without a dictionary "Window smachines" is just as consistent with the data,
 ...
 * as "...Okta DeviceTrust..." and "...WindowsMachines...". A pure
 * lowercase-to-uppercase rule was tried first and was actively harmful: it
 * repaired "DeviceTrust" but destroyed "macOS/iOS", "iPhone" and "BitLocker",
